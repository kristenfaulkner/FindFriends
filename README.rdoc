...
- Allow the ability for users to add friends, and only display the location of their friends.
Furthermore, a user's location will only be visible to their friends.
