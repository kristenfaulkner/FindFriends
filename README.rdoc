...
- Have the map update a user's location in real time (using their phone/device's IP address instead of getting it every time they log into the app). This is trivial with the Google Map API,
